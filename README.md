...
**music-chore** is a lightweight, blazing-fast CLI tool that brings order to chaotic music libraries. It works entirely offline—reading and normalizing metadata from your existing files and directory structure. No internet lookups, no external services, just pure local processing.
...
### 🌳 `tree` - Visualize Library Structure
...
│   ├── traits.rs           # AudioFile trait for extensibility
...
**Built by AI Agent with ❤️ for music lovers and AI agents**
