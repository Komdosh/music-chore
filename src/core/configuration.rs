...
pub struct AppConfig {
    ...
    /// Default confidence threshold for inferred metadata
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            skip_metadata_by_default: false,  // Default to reading metadata
            excluded_extensions: vec!["tmp".to_string(), "log".to_string(), "bak".to_string()],
            excluded_directories: vec![".git".to_string(), "node_modules".to_string(), ".DS_Store".to_string()],
...
impl AppConfig {
    ...
    pub fn load_from_file<P: AsRef<Path>>(path: P) -> Result<Self, crate::core::errors::MusicChoreError> {
    ...
    pub fn save_to_file<P: AsRef<Path>>(&self, path: P) -> Result<(), crate::core::errors::MusicChoreError> {
