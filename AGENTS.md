...
- Commands: scan, tree, read, write, normalize, emit, validate, duplicates
...
- MCP tools: scan_directory, read_file_metadata, get_library_tree, emit_library_metadata, normalize_titles, validate_library, find_duplicates
